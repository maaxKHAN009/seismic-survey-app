...
class SeismicAnalyzerApp(ctk.CTk):
    ...
    def create_sidebar(self):
        ...
        self.query_col.grid(row=14, column=0, padx=20, pady=5, sticky="ew")
        
        self.query_op = ctk.CTkOptionMenu(self.sidebar,
                                         values=["=", "!=", ">", "<", ">=", "<=", "contains"],
                                         fg_color="#334E68", button_color="#243B53")
        self.query_op.set("=")
        self.query_op.grid(row=15, column=0, padx=20, pady=5, sticky="ew")
        
        self.query_val = ctk.CTkEntry(self.sidebar, placeholder_text="Value...",
                                     fg_color="#102A43", border_color="#334E68", text_color=WHITE)
        self.query_val.grid(row=16, column=0, padx=20, pady=5, sticky="ew")
        
        filter_frame = ctk.CTkFrame(self.sidebar, fg_color="transparent")
        filter_frame.grid(row=17, column=0, padx=20, pady=10, sticky="ew")
...
"""
    ...
    def load_file(self):
        """Load Excel file with smart column detection"""
        ...
        try:
            ...
            if self.cols:
                self.chart_col.set(self.cols[0])
