      ...
      {isAdmin && (
        <div className="space-y-6 animate-in slide-in-from-top-4">
          ...
          <div className="bg-[#001F3F] p-6 rounded-3xl text-white space-y-6 shadow-lg">
            ...
            <div className="space-y-3">
                <select className="w-full p-3 bg-white/10 rounded-xl text-black font-bold border border-white/10 text-slate-500" value={targetSectionId} onChange={(e) => setTargetSectionId(e.target.value)}>
                ...
                <div className="grid grid-cols-2 gap-3">
                    ...
                    <select className="p-3 bg-white/10 rounded-xl text-black font-bold border border-white/10 text-slate-500" value={newFieldType} onChange={(e) => setNewFieldType(e.target.value as FieldType)}>
